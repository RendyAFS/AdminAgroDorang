...
<head>
    ...
    <style>
        body {
            ...
            height: 100vh;
            /* Menetapkan tinggi elemen body ke 100% dari tinggi viewport */
            margin: 0;
            /* Menghapus margin bawaan yang dapat memengaruhi tinggi body */
        }

        .navbar {
            background-color: rgb(71, 88, 137, 0.8);
        }
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a href="/dasboards" class="dropdown-item text-dark"><i class="bi bi-box-arrow-in-right me-2"></i>
                                        Masuk
                                    </a>
