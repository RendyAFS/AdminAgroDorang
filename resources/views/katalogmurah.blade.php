        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <p>
                    ...
                    <span style="opacity: 1;">listkatalogmurah</span>
                </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex justify-content-end mb-4">
                    <a href="https://www.compress2go.com/id/kompres-jpg" target="__blank" class="btn btn-danger me-2 shadow">
                        <i class="bi bi-images me-2"></i> Kompress IMG
                    </a>
                    <a href="{{ route('katalog2.index') }}" target="__blank" class="btn btn-success me-2 shadow">
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                @include('actions.TambahProductMurah')
                            </div>
                        </div>
                    </div>
                </div>
