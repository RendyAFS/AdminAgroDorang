    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="d-flex justify-content-center align-items-middle">
                <img class="gmbr-produk" src="{{ asset('storage/GambarProduk/' . $murahs->gambar_product) }}" alt="{{ $murahs->nama_product }}">
            </div>
        </div>
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('murahs.update', $murahs->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf <!-- CSRF token -->
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" class="form-control border-dark" id="nama_product" name="nama_product"
                                value="{{ $murahs->nama_product }}" required>
                        </div>
                        <div class="form-group mt-3 row">
                            <div class="col-md-8">
                                ...
                                <input type="number" class="form-control border-dark" id="harga_product" name="harga_product"
                                    value="{{ $murahs->harga_product }}" required>
                            </div>
                            <div class="col-md-4">
                                ...
                                <select name="satuans_id" id="table_satuans_id" class="form-select border-dark" required>
                                    ...
                                    @foreach ($satuans as $satuan)
                                        <option value="{{ $satuan->id }}"
                                            {{ $murahs->satuans_id == $satuan->id ? 'selected' : '' }}>
                                            {{ $satuan->nama_satuan }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <div class="p-1">
                                <textarea style="width: 100%;" cols="100" rows="5" id="deskripsi_product" name="deskripsi_product" required>{{ $murahs->deskripsi_product }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" class="form-control border-dark" id="stok_product" name="stok_product"
                                value="{{ $murahs->stok_product }}" required>
                        </div>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-3 d-grid">
                                <a href="{{route("murahs.index")}}" class="btn btn-danger me-1 shadow">
                                    Batal
                                </a>
                            </div>
                            <div class="col-3"></div>
