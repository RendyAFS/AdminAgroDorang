<form action="{{ route('murahs.store') }}" method="POST" enctype="multipart/form-data">
    @csrf <!-- CSRF token -->
    ...
    <div class="form-group mt-3 row">
        <div class="col-md-8">
            ...
            <input type="number" class="form-control border-dark" id="harga_product" name="harga_product"
                value="{{ old('harga_product') }}" required>
        </div>
        <div class="col-md-4">
    ...
    <div class="form-group mt-3">
        ...
        <div class="p-1">
            <textarea style="width: 100%;" cols="100" rows="5" id="deskripsi_product" name="deskripsi_product" required>{{ old('deskripsi_product') }}</textarea>
        </div>
    </div>

    <div class="form-group mt-3">
        <label for="gambar_product" class="fw-bold">Gambar Product:</label>
        <input type="file" class="form-control border-dark @error('gambar_product') is-invalid @enderror" id="gambar_product" name="gambar_product" value="{{ old('gambar_product') }}" required>
    ...
    <div class="form-group mt-3">
        ...
        <input type="text" class="form-control border-dark" id="stok_product" name="stok_product"
            value="{{ old('stok_product') }}" required>
    </div>
